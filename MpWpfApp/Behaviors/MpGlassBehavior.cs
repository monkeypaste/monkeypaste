...
namespace MpWpfApp {
    ...
    /// </summary>
    public class MpGlassBehavior : Behavior<FrameworkElement> {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new instance of the MpGlassBehavior
        /// </summary>
        public MpGlassBehavior() {
        ...
        private static void OnVisualChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            ((MpGlassBehavior)d).OnVisualChanged(e);
        }
        ...
        public static readonly DependencyProperty EffectProperty =
            DependencyProperty.Register("Effect", typeof(Effect), typeof(MpGlassBehavior),
                new FrameworkPropertyMetadata(null,
        ...
        private static void OnEffectChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            ((MpGlassBehavior)d).OnEffectChanged(e);
        }

...
namespace MpWpfApp {
    public class MpKineticBehaviour {
        #region Friction
        ...
        public static readonly DependencyProperty FrictionProperty =
           DependencyProperty.RegisterAttached("Friction",
            typeof(double), typeof(MpKineticBehaviour),
        ...
        private static readonly DependencyProperty ScrollStartPointProperty =
          DependencyProperty.RegisterAttached("ScrollStartPoint",
           typeof(Point), typeof(MpKineticBehaviour),
        ...
        private static readonly DependencyProperty InertiaProcessorProperty =
            ...
            typeof(InertiaHandler), typeof(MpKineticBehaviour),
        ...
        public static readonly DependencyProperty
            ...
            typeof(bool), typeof(MpKineticBehaviour),
        ...
        private static void OnHandleKineticScrollingChanged(DependencyObject d,
            ...
            if ((bool)e.NewValue) {
                ...
                scoller.PreviewMouseWheel += OnPreviewMouseWheel;
        ...
        private static void OnPreviewMouseWheel(object sender, MouseEventArgs e) {
            var scrollViewer = (ScrollViewer)sender;
            if (scrollViewer.IsMouseCaptured) {
                Point currentPoint = e.GetPosition(scrollViewer);
            ...
            private void HandleWorldTimerTick(object sender, EventArgs e) {
                if (scroller.IsMouseCaptured) {
                    ...
                    if (velocity.Length > 1) {
                        ...
                        velocity *= MpKineticBehaviour.GetFriction(scroller);
                    }
                }
            }

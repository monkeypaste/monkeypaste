...
namespace MpWpfApp {
    ...
    class FileDataSource2 : INotifyCollectionChanged, System.Collections.IList, IItemsRangeInfo, ISelectionInfo {
        ...
        private MpItemCacheManager<FileItem> itemCache;
        ...
        private FileDataSource2() {
            ...
            this.itemCache = new MpItemCacheManager<FileItem>(fetchDataCallback, 50);
            this.itemCache.CacheChanged += ItemCache_CacheChanged;

            // Create another ItemCacheManager for the keys for selection
            this.selectionCache = new MpItemCacheManager<string>(fetchSelectionDataCallback, 50, "selectionCache");
        }
        ...
        private MpItemCacheManager<string> selectionCache;
        // List of ranges that form the selection
        private MpItemIndexRangeList selection = new MpItemIndexRangeList();
        ...
        private async Task RemapSelection() {
            MpItemIndexRangeList oldSelection = selection;
            MpItemCacheManager<string> oldSelectionCache = selectionCache;
            MpItemIndexRangeList newSelection = new MpItemIndexRangeList();
            MpItemCacheManager<string> newSelectionCache = new MpItemCacheManager<string>(fetchSelectionDataCallback, 50, "newSelectionCache");
        ...
        private void ItemCache_CacheChanged(object sender, MpCacheChangedEventArgs<FileItem> args) {
            if (CollectionChanged != null) {

...
namespace MpWpfApp
{
    ...
    public class MpClipTileViewModelDataSource : INotifyCollectionChanged, System.Collections.IList, IItemsRangeInfo
    {
        ...
        private ItemCacheManager<MpClipTileViewModel> itemCache;
        ...
        private MpClipTileViewModelDataSource()
        {
            ...
            //_dispatcher = Windows.ApplicationModel.Core.CoreApplication.GetCurrentView().CoreWindow.Dispatcher; // Windows.UI.Xaml.Window.Current.Dispatcher;
            //_dispatcher = cd;
            ...
            this.itemCache = new ItemCacheManager<MpClipTileViewModel>(fetchDataCallback, 50);
        ...
        {
            return (value != null) ? itemCache.IndexOf((MpClipTileViewModel)value) : -1;
        }
...
//#endif
        ...
        private void ItemCache_CacheChanged(object sender, CacheChangedEventArgs<MpClipTileViewModel> args)
        {
            if (CollectionChanged != null)
            {

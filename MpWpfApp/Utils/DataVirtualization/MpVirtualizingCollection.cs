...
namespace MpWpfApp {
    ...
    /// and pages are dynamically fetched from the MpIItemsProvider when required. Stale pages are removed after a
    ...
    public class MpVirtualizingCollection<T> : IList<T>, IList, INotifyCollectionChanged, INotifyPropertyChanged {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MpVirtualizingCollection&lt;T&gt;"/> class.
        /// </summary>
        /// <param name="itemsProvider">The items provider.</param>
        /// <param name="pageSize">Size of the page.</param>
        /// <param name="pageTimeout">The page timeout.</param>
        public MpVirtualizingCollection(MpIItemsProvider<T> itemsProvider, int pageSize, int pageTimeout) {
        ...
        /// <param name="itemsProvider">The items provider.</param>
        /// <param name="pageSize">Size of the page.</param>
        public MpVirtualizingCollection(MpIItemsProvider<T> itemsProvider, int pageSize) {
            _itemsProvider = itemsProvider;
            _pageSize = pageSize;
        }
        ...
        /// </summary>
        /// <param name="itemsProvider">The items provider.</param>
        public MpVirtualizingCollection(MpIItemsProvider<T> itemsProvider) {
            _itemsProvider = itemsProvider;
        }
        ...
        public MpIItemsProvider<T> ItemsProvider {
        ...
        /// The first time this property is accessed, it will fetch the count from the MpIItemsProvider.
        /// </summary>
        /// <value></value>
        /// <returns>
        ...
        /// the corresponding page from the MpIItemsProvider if required.
        /// </summary>
        /// <value></value>
        ...
        /// <summary>
        /// Fetches the requested page from the MpIItemsProvider.
        /// </summary>
        /// <param name="pageIndex">Index of the page.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Fetches the count of itmes from the MpIItemsProvider.
        /// </summary>
        /// <returns></returns>

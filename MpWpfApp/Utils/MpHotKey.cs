...
namespace MpWpfApp {
    ...
    /// </summary>
    [Serializable]
    public class MpHotKey : INotifyPropertyChanged, ISerializable, IEquatable<MpHotKey> {
        /// <summary>
        ...
        public MpHotKey(Key key, ModifierKeys modifiers) : this(key, modifiers, true) { }
        ...
        public MpHotKey(Key key, ModifierKeys modifiers, bool enabled) {
            Key = key;
            Modifiers = modifiers;
            Enabled = enabled;
        }
        ...
        protected MpHotKey(SerializationInfo info, StreamingContext context) {
    ...
    public sealed class MpHotKeyHost : IDisposable {
        ...
        private void RegisterHotKey(int id, MpHotKey hotKey) {
        ...
        private Dictionary<int, MpHotKey> hotKeys = new Dictionary<int, MpHotKey>();
        ...
        /// </summary>
        public IEnumerable<MpHotKey> HotKeys { get { return hotKeys.Values; } }
        ...
        public void AddHotKey(MpHotKey hotKey) {
            if(hotKey == null)
        ...
        public bool RemoveHotKey(MpHotKey hotKey) {

...
namespace MpWpfApp
{
    ...
    /// </summary>
    public class MpBindableListBox : ListBox
    {
        public MpBindableListBox()
        {
        ...
        public static new readonly DependencyProperty SelectedItemsProperty =
           DependencyProperty.Register("SelectedItems", typeof(IList), typeof(MpBindableListBox),
           new FrameworkPropertyMetadata(
                  (d, e) =>
                  {
                      // When the property changes, update the selected values in the selectedItems box.
                      (d as MpBindableListBox).SetSelectedItemsNew(e.NewValue as IList);
                  }));
        /// <summary>

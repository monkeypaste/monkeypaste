...
namespace MpWpfApp {
    public class MpSubTextTokenCollectionViewModel : MpObservableCollectionViewModel<MpTemplateTokenViewModel> {
        #region View Models
        ...
        public MpSubTextTokenCollectionViewModel(MpClipTileViewModel ctvm) : base() {
        }
        #endregion
    }
}

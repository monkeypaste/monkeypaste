            ...
            await Task.Run(() => {
                ...
                switch (SoundGroup) {
                    ...
                    case MpSoundGroup.Minimal:
                        SoundPlayerViewModels.Add(new MpSoundPlayerViewModel(MpSoundType.Copy, MpPrefViewModel.Instance.NotificationCopySound1Path));
                        SoundPlayerViewModels.Add(new MpSoundPlayerViewModel(MpSoundType.AppendOn, MpPrefViewModel.Instance.NotificationAppendModeOnSoundPath));
                        SoundPlayerViewModels.Add(new MpSoundPlayerViewModel(MpSoundType.AppendOff, MpPrefViewModel.Instance.NotificationAppendModeOffSoundPath));
                        SoundPlayerViewModels.Add(new MpSoundPlayerViewModel(MpSoundType.Loaded, MpPrefViewModel.Instance.NotificationLoadedPath));
                        break;
                }

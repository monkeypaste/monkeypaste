...
namespace MonkeyPaste.Avalonia {
    ...
    public class MpAvComponentPickerParameterViewModel : 
        ...
        public MpSelectableComponentType ComponentType =>
           UnitType switch {
               MpPluginParameterValueUnitType.CollectionComponentId => 
                        MpSelectableComponentType.Collection,
                    MpPluginParameterValueUnitType.ActionComponentId => 
                        MpSelectableComponentType.Action,
                    MpPluginParameterValueUnitType.AnalyzerComponentId => 
                        MpSelectableComponentType.Analyzer,
        ...
        public MpAvComponentPickerParameterViewModel(MpIPluginComponentViewModel parent) : base(parent) { }

...
namespace MonkeyPaste.Avalonia {
    public class MpAvShortcutRecorderParameterViewModel : 
        MpAvPluginParameterViewModelBase, MpAvIShortcutCommandViewModel {
        ...
        public MpAvShortcutRecorderParameterViewModel(MpIPluginComponentViewModel parent) : base(parent) { }

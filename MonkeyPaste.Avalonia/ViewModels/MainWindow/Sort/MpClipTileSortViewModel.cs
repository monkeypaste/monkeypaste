...
namespace MonkeyPaste.Avalonia {
    public class MpClipTileSortViewModel : MpViewModelBase, MpIAsyncSingletonViewModel<MpClipTileSortViewModel> {
        ...
        public string SortImagePath {
            get {
                if(SelectedSortType == null) {
                    return MpPlatformWrapper.Services.PlatformResource.GetResource("DecendingImange") as string;
                }
                if(IsSortDescending) { 
                    if(SelectedSortType.SortType == MpContentSortType.Manual) {
                        return MpPlatformWrapper.Services.PlatformResource.GetResource("DecendingImage_Disabled") as string;
                    }
                    return MpPlatformWrapper.Services.PlatformResource.GetResource("DecendingImange") as string;
                }
                if (SelectedSortType.SortType == MpContentSortType.Manual) {
                    return MpPlatformWrapper.Services.PlatformResource.GetResource("AscendingImage_Disabled") as string;
                }
                return MpPlatformWrapper.Services.PlatformResource.GetResource("AscendingImange") as string;
            }
        }
        ...
        #region Commands
        public ICommand ToggleSortOrderCommand => new MpCommand(
            () => {

            ...
            get {
                if (_defaultShortcutDefinitions == null) {
                    ...
                    _defaultShortcutDefinitions = new List<string[]>() {
                        // ORDER:
                        // guid,keyString,shortcutType,routeType, readOnly = false, isInternalOnly = true

                        // GLOBAL
                
                            new string[] {"5dff238e-770e-4665-93f5-419e48326f01","Control+F1", MpShortcutType.ToggleMainWindow.ToString(), mw_routing.ToString(),"False","False"},
                            ...
                            new string[] {"777367e6-c161-4e93-93e0-9bf12221f7ff", "Control+Shift+F5", MpShortcutType.ToggleAppendBlockMode.ToString(), globalRouting.ToString(),"False","False"},
                            new string[] {"a41aeed8-d4f3-47de-86c5-f9ca296fb103", "Control+Shift+F6", MpShortcutType.ToggleAppendInlineMode.ToString(), globalRouting.ToString(),"False","False"},
                            new string[] {"9fa72a1b-2286-4907-bf70-37686aad009a", "Control+Shift+F7", MpShortcutType.ToggleAppendPositionMode.ToString(), globalRouting.ToString(),"False","False"},
                            ...
                            new string[] {"cb807500-9121-4e41-80d3-8c3682ce90d9","Esc", MpShortcutType.DecreaseFocus.ToString(), mw_routing.ToString(),"True"},
                            new string[] {"5d739e44-2d4d-4d62-839b-9360f7dd04b5","Space", MpShortcutType.IncreaseFocus.ToString(), MpRoutingType.Internal.ToString(),"True"},
                            ...
                            new string[] {"728bfb06-1d96-441c-b710-efee383138be","Control+G", MpShortcutType.ToggleAppendDirectionMode.ToString(), MpRoutingType.Internal.ToString()},

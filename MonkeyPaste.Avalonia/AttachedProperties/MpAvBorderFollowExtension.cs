...
namespace MonkeyPaste.Avalonia {
    public static class MpAvBorderFollowExtension {
        ...
        #region Statics
        static MpAvBorderFollowExtension() {
            IsBorderFollowEnabledProperty.Changed.AddClassHandler<Control>((x, y) => HandleIsEnabledChanged(x, y));

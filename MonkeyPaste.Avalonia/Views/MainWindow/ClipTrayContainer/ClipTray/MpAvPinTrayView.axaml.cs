...
namespace MonkeyPaste.Avalonia {
    public partial class MpAvPinTrayView : MpAvUserControl<MpAvClipTrayViewModel>, MpAvIDropHost {
        //public ListBox PinTrayListBox { get; private set; }
        ...
        async Task<DragDropEffects> MpAvIDropHost.DropDataObjectAsync(IDataObject avdo, MpPoint host_mp, DragDropEffects effects) {
            ...
            if (effects == DragDropEffects.None || drop_idx < 0) {
                return effects;
            }

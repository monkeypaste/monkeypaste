...
adb shell run-as com.Monkey.MonkeyPaste "cp files/MonkeyPaste_DEBUG/mp_android.mpcdb /sdcard/ && exit"
adb shell run-as com.Monkey.MonkeyPaste "cp files/MonkeyPaste_DEBUG/mp_android.mpcdb-shm /sdcard/ && exit"
adb shell run-as com.Monkey.MonkeyPaste "cp files/MonkeyPaste_DEBUG/mp_android.mpcdb-wal /sdcard/ && exit"

...
namespace CefNet.CApi
{
	...
	public unsafe partial struct cef_browser_host_t
	{
		...
		/// <summary>
		/// void (*)(_cef_browser_host_t* self, const cef_string_t* path, const _cef_pdf_print_settings_t* settings, _cef_pdf_print_callback_t* callback)*
		/// </summary>
		...
		/// <summary>
		/// void (*)(_cef_browser_host_t* self, const _cef_window_info_t* windowInfo, _cef_client_t* client, const _cef_browser_settings_t* settings, const cef_point_t* inspect_element_at)*
		/// </summary>

...
namespace MonkeyPaste.Common {
    public static class MpSystemColors {
        ...
        private static string[] _spectrumColors = new string[] {
            Red,
            orange1,
            Yellow,
            green1,
        ...
        public static string[] SpectrumColors =>
            _spectrumColors;

        private static string[] _contentColors = new string[] {
            // NOTE is 5x14 
            "#FFF8A0AD",
            "#FFFCA844",
            "#FFD79D3B",
        ...
        public static string[] ContentColors =>
            _contentColors;

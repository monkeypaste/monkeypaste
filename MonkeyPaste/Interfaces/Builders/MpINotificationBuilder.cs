...
namespace MonkeyPaste {
    public interface MpINotificationBuilder {
        ...
        Task ShowMessageAsync(string title = "", object body = null, int maxShowTimeMs = MpNotificationFormat.MAX_MESSAGE_DISPLAY_MS, MpNotificationType msgType = MpNotificationType.Message, object iconSourceObj = null, object anchor = null);

...
namespace MonkeyPaste {
    public class MpExcludedAppListPanelController : MpController {
        public MpExcludedAppListPanel ExcludedAppListPanel { get; set; }
        ...
        public MpExcludedAppListPanelController(MpController pc) : base(pc) {
            ExcludedAppListPanel = new MpExcludedAppListPanel()
            {
                AutoSize = false
            };
            bool altRowColor = false;
            List<MpApp> excludedAppList = (List<MpApp>)MpLogFormController.Db.GetExcludedAppList();
        ...
        public override void Update() {
            //settings form size
            Size sfs = ((MpSettingsFormController)Find("MpSettingsFormController"))

...
namespace MonkeyPaste {
    public class MpLoadOnLoginCheckBoxController : MpController {
        public MpLoadOnLoginCheckBox LoadOnStartUpCheckbox { get; set; }
        ...
        public MpLoadOnLoginCheckBoxController(MpController p) : base(p) {
            ...
            LoadOnStartUpCheckbox = new MpLoadOnLoginCheckBox();
            LoadOnStartUpCheckbox.Checked = !((rk.GetValue(Properties.Settings.Default.AppName) == null || (bool)rk.GetValue(Properties.Settings.Default.AppName) == false));

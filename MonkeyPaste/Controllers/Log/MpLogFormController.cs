...
namespace MonkeyPaste
{
    public class MpLogFormController : MpController {
        ...
        private Point _startDragPoint = Point.Empty,_lastMousePoint;
        ...
        public void _moveHook_MouseMove(object sender,MouseEventArgs e) {
            ...
            if(LogForm == null || !LogForm.Visible) {
                ...
                else if(LogFormPanelController.TileChooserPanelController.DragTilePanelController != null) {
                    LogFormPanelController.TileChooserPanelController.DragTilePanelController.TilePanel.Location = MpPointMath.Add(
                        LogFormPanelController.TileChooserPanelController.DragTilePanelController.TilePanel.Location,
                        MpPointMath.Subtract(e.Location,_lastMousePoint)
                    );
        ...
        private void _upHook_MouseUp(object sender,MouseEventArgs e) {
            ...
            if(LogFormPanelController.TileChooserPanelController.DragTilePanelController != null) {
                EndTileDrag();
            }
        }
        private void _mouseDownHook_MouseDown(object sender,MouseEventArgs e) {
            ...
            MpTilePanelController dragTileController = LogFormPanelController.TileChooserPanelController.GetTilePanelControllerAtLocation(e.Location);
            if(dragTileController != null) {
                StartTileDrag(dragTileController);
            }
        }
        ...
        #endregion
        public void StartTileDrag(MpTilePanelController dragTilePanelController) {
            LogFormPanelController.TileChooserPanelController.DragTilePanelController = dragTilePanelController;
            if(LogFormPanelController.TileChooserPanelController.DragTilePanelController == null) {
                return;
            }
            //detach tilepanel from chooser and reproject location overtop the logform
            //get tp screen location
            LogFormPanelController.TileChooserPanelController.DragTilePanelStartLocation = LogFormPanelController.TileChooserPanelController.TileChooserPanel.PointToScreen(LogFormPanelController.TileChooserPanelController.DragTilePanelController.TilePanel.Location);
            LogFormPanelController.TileChooserPanelController.TileChooserPanel.Controls.Remove(LogFormPanelController.TileChooserPanelController.DragTilePanelController.TilePanel);
            LogForm.Controls.Add(LogFormPanelController.TileChooserPanelController.DragTilePanelController.TilePanel);
            LogFormPanelController.TileChooserPanelController.DragTilePanelController.TilePanel.Location = LogForm.PointToClient(LogFormPanelController.TileChooserPanelController.DragTilePanelStartLocation);
            LogFormPanelController.TileChooserPanelController.DragTilePanelController.TilePanel.BringToFront();
            LogFormPanelController.TileChooserPanelController.DragTilePanelController.TilePanel.Invalidate();
        }
        public void EndTileDrag() {
            LogForm.Controls.Remove(LogFormPanelController.TileChooserPanelController.DragTilePanelController.TilePanel);
            LogFormPanelController.TileChooserPanelController.TileChooserPanel.Controls.Add(LogFormPanelController.TileChooserPanelController.DragTilePanelController.TilePanel);
            LogFormPanelController.TileChooserPanelController.DragTilePanelController.TilePanel.Location = LogFormPanelController.TileChooserPanelController.TileChooserPanel.PointToClient(LogFormPanelController.TileChooserPanelController.DragTilePanelStartLocation);
            LogFormPanelController.TileChooserPanelController.DragTilePanelController.TilePanel.BringToFront();
            LogFormPanelController.TileChooserPanelController.DragTilePanelController.TilePanel.Invalidate();

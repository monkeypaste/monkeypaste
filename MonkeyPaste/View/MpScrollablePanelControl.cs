...
namespace MonkeyPaste {
    ...
    [Designer(typeof(MpScrollablePanelControl))] //Set the desiner to the custom ScrollAblePanel designer
    [Docking(DockingBehavior.Ask)]              //propts the user to dock the control
    public partial class MpScrollAblePanelControl:UserControl {
        //VARIABLES
        ...
        //CONSTRUCTOR
        public MpScrollAblePanelControl() {
            InitializeComponent();
        }
        ...
        private void MpScrollAblePanelControl_MouseDown(object sender,MouseEventArgs e) {
        ...
        private void MpScrollAblePanelControl_MouseMove(object sender,MouseEventArgs e) {
        ...
        private void MpScrollAblePanelControl_MouseUp(object sender,MouseEventArgs e) {
            if(_IsMouseDown) {
                //finished scrolling
                _IsMouseDown = false;
            }
        ...
        private void UpdateScrollAtLocation(int delta) {
            int newY = ScrollAt.Location.Y + (int)(-delta * 0.05f);
            newY = newY < ScrollContainter.Location.Y ? ScrollContainter.Location.Y : newY;
            newY = newY > ScrollContainter.Location.Y + ScrollContainter.Height ? ScrollContainter.Location.Y + ScrollContainter.Height : newY;
            ScrollAt.Location = new Point(ScrollAt.Location.X,newY);
            CalculateScrollPanel();
        }
        ...
        private void MpScrollAblePanelControl_SizeChanged(object sender,EventArgs e) {
        ...
        private void MpScrollAblePanelControl_Load(object sender,EventArgs e) {
            this.MouseWheel += MpScrollAblePanelControl_MouseWheel;
        }

        private void MpScrollAblePanelControl_MouseWheel(object sender,MouseEventArgs e) {
            UpdateScrollAtLocation(e.Delta);
        }
    }


    //The Desinger Class
    internal class MpScrollablePanelControlDesigner:System.Windows.Forms.Design.ParentControlDesigner {
        public override void Initialize(System.ComponentModel.IComponent component) {
            base.Initialize(component);

            if(this.Control is MpScrollAblePanelControl) {
                this.EnableDesignMode((
                   //get the EditablePanel attritubute from the class ScrollAblePanelControl
                   (MpScrollAblePanelControl)this.Control).EditablePanel,"EditablePanel");
            }
        }
    }
}

...
namespace MonkeyPaste {
    ...
    public class MpPlatform : MpDBObject {
        ...
        public MpPlatform(int platformId) {
            DataTable dt = MpLogFormController.Db.Execute("select * from MpPlatform where pk_MpPlatformId=" + platformId);
        ...
        public override void WriteToDatabase() {
            if(Version == null || Version == string.Empty || MpLogFormController.Db.NoDb) {
            ...
            if(PlatformId == 0) {
                ...
                if(dt != null && dt.Rows.Count > 0) {
                    ...
                    MpLogFormController.Db.ExecuteNonQuery("insert into MpPlatform(fk_MpPlatformTypeId,fk_MpDeviceTypeId,Version) values(" + (int)PlatformType + "," + (int)DeviceType + ",'" + Version + "')");
                    PlatformId = MpLogFormController.Db.GetLastRowId("MpPlatform","pk_MpPlatformId");
                }
            }
            else {

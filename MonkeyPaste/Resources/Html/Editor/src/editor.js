...
function registerTemplateSpan() {
    ...
    class TemplateSpanBlot extends Parchment.EmbedBlot {
        static create(value) {
            ...
            node.setAttribute('templateSubType', value.templateSubType);
        ...
        static value(domNode) {
            return {
                ...
                templateSubType: domNode.getAttribute('templateSubType'),
            }
        }
...
function templateTypeChanged(e) {
...
function getTemplates() {
    ...
    for (var i = 0; i < domTemplates.length; i++) {
        ...
        var template = {
            ...
            templateSubType: domTemplate.getAttribute('templateSubType'),
            docIdx: domTemplate.getAttribute('docIdx'),
...
function hideEditTemplateToolbar() {
    ...
    document.getElementById('editTemplateTypeMenuSelector').removeEventListener('change', templateTypeChanged);
}
...
function showToolbar() {
    ...
    if (isShowingPasteTemplateToolbar) {
        movePasteTemplateToolbarTop(tbh);
        let pttbh = $("#pasteTemplateToolbar").outerHeight();
...
function getTemplateIconStr(isEnabled) {
    if (isEnabled) {
        ...
        //init('hello', null, null, null, null);
...
function init_test(doText = true) {
	...
	let sample_template_single = '<p>WHAAAT UP HOMMEEE </p><p><br></p><p> <div class="ql-template-embed-blot ql-template-embed-blot-display-key-up" templateguid="f9613da8-3d00-466f-9bad-1b006e0c8917" templateinstanceguid="250b96ff-6a2d-4825-9286-d176953c381c" templatename="yoyoyo how ya doin?" templatetype="dynamic" templatecolor="#78BA43" templatedata="" templatetext="undefined" templatedeltaformat="{}" templatehtmlformat="Template #1" style="background-color: rgb(120, 186, 67); color: white;" contenteditable="false" isfocus="false" spellcheck="false">yoyoyo how ya doin?</div>  </p><p><br></p><p>THIS IS THE BEST TEST EVA!Q!@@</p>';

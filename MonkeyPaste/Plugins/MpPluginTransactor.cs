    ...
    public static class MpPluginTransactor {
        ...
        public static async Task<object> PerformTransaction(
            ...
            if(pluginComponent is MpIAnalyzerPluginComponent analyzerPlugin) {
                ...
                // FIND CONTENT
                MpAnalyticItemParameterFormat contentParam = pluginFormat.analyzer.parameters
                    .FirstOrDefault(x => x.unitType == MpAnalyticItemParameterValueUnitType.ContentQuery);

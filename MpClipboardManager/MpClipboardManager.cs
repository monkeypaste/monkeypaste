...
namespace MpWinFormsUtilities {
    public class MpClipboardMonitor {
        private static readonly Lazy<MpClipboardMonitor> lazy = new Lazy<MpClipboardMonitor>(() => new MpClipboardMonitor());
        public static MpClipboardMonitor Instance { get { return lazy.Value; } }
        ...
        public void Start() {
            ...
            _lastWindowWatcher = new MpLastWindowWatcher(ClipboardWatcher.handle);
        }
        ...
        class ClipboardWatcher : Form {
            ...
            public static void Start() {
                ...
                if(mInstance != null)
                    return;
                var cw = new ClipboardWatcher();
                var t = new Thread(new ParameterizedThreadStart(x => Application.Run(cw)));

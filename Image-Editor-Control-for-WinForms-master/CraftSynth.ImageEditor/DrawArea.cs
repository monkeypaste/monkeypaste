...
namespace CraftSynth.ImageEditor
{
  ...
  internal partial class DrawArea : UserControl, IDisposable
  {
    ...
    private ImageEditorControl owner;
    ...
    private ImageEditorControl myparent;

    public ImageEditorControl MyParent
    {
      get { return myparent; }
      set { myparent = value; }
    }
    ...
    /// </summary>
    public ImageEditorControl Owner
    {
      get { return owner; }
      set { owner = value; }
    }
    ...
    public void Initialize(ImageEditorControl owner, DocManager docManager, Image initialImage, string initialImageAsFilePath, byte[] initialImageAsPngBytes)
    {

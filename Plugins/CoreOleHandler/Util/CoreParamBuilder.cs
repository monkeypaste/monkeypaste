...
namespace CoreOleHandler {
    public static class CoreParamBuilder {
        const int DEF_MAX_TEXT = 1_000_000;
        static string PluginGuid => "cf2ec03f-9edd-45e9-a605-2a2df71e03bd";
        static string IconDir => @".\Resources\Images";

        static (string, string, int, string)[] _formats = new (string, string, int, string)[] {
                ("Text","Text",DEF_MAX_TEXT,"text.png"),
                ("text/plain","Text (web)",DEF_MAX_TEXT,"text.png"),
                ("Rich Text Format","Rtf",DEF_MAX_TEXT,"rtf.png"),
                ("HTML Format","Html",DEF_MAX_TEXT,"html.png"),
                ("text/html","Html (web)",DEF_MAX_TEXT,"html.png"),
                ("text/x-moz-url-priv","Uri",-1,"html.png"),
                ("PNG","Png",-1,"bitmap.png"),
                ("Csv","Csv",DEF_MAX_TEXT,"csv.png"),
                ("Files","Files",-1,"files.png"),
        ...
        private static string GetParamId(string format, bool isReader, string detail) {
            format =
                format

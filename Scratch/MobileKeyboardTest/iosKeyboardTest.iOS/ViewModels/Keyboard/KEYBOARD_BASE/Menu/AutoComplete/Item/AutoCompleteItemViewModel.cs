namespace iosKeyboardTest.iOS {
    public class AutoCompleteItemViewModel : ViewModelBase, IKeyboardViewRenderer, IKeyboardRenderSource {
        ...
        #region View Models
        public AutoCompleteViewModel Parent { get; private set; }
        #endregion
        ...
        #region Constructors
        public AutoCompleteItemViewModel(AutoCompleteViewModel parent) {
            Parent = parent;
        }
        #endregion

...
$sub_type = $expires_utc_dt = $email = $username = $password = $confirm_password = "";
$sub_type_err = $expires_utc_dt_err = $email_err = $username_err = $password_err = $confirm_password_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST" ||
    ...
    } elseif(!preg_match('/^([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})$/', trim($_POST["email"]))){
    ...
    } elseif(!preg_match('/^([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})$/', trim($_POST["username"]))){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)) {            
                ...
                if(!empty($_POST["device_guid"]) && 
                    ...
                    // non-browser registration, add subscription

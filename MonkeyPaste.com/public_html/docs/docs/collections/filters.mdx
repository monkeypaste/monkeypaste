...
## Auto-Search
By default, if you aren't in a textbox typing any letter or number will automatically start typing your input into the search box. 

:::tip Search Preferences
Auto-search can also be disabled in *Settings->Preferences->Search* menu.
:::
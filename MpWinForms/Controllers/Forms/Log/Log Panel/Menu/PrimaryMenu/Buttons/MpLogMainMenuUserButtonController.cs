...
namespace MonkeyPaste {
    public class MpLogMainMenuUserButtonController:MpController {
        ...
        public override void Update() {
            ...
            Rectangle lmmpr = ((MpLogMainMenuPanelController)Find("MpLogMainMenuPanelController")).LogMainMenuPanel.Bounds;
            //log main menu info button rect
            Rectangle lmmibr = ((MpLogMainMenuInfoButtonController)Find("MpLogMainMenuInfoButtonController")).LogMainMenuInfoButton.Bounds;
            //icon pad

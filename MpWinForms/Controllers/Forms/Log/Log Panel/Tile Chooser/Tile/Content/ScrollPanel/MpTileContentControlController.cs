...
namespace MonkeyPaste {
    public class MpTileContentControlController : MpController {
        ...
        public MpTileContentControlController(MpCopyItem ci,MpController parent) : base(parent) {
            switch (ci.CopyItemType) {
                ...
                case MpCopyItemType.Text:
                    TileContentControl = new MpTextBox() {
        ...
        public override Rectangle GetBounds() {
            ...
            if (TileContentControl.GetType() == typeof(MpTextBox)) {
                ...
                ((MpTextBox)TileContentControl).Font = f;
                contentSize = TextRenderer.MeasureText(((MpTextBox)TileContentControl).Text, f);
            }

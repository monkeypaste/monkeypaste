...
namespace MpWinFormsApp {
    public class MpShadowPanel:Panel {
        ...
        static Image shadowDownRight = Properties.Resources.tshadowdownright;//new Bitmap(typeof(ShadowPanel),"Images.tshadowdownright.png");
        static Image shadowDownLeft = Properties.Resources.tshadowdownleft;//new Bitmap(typeof(ShadowPanel),"Images.tshadowdownleft.png");
        static Image shadowDown = Properties.Resources.tshadowdown;//new Bitmap(typeof(ShadowPanel),"Images.tshadowdown.png");
        static Image shadowRight = Properties.Resources.tshadowright;//new Bitmap(typeof(ShadowPanel),"Images.tshadowright.png");
        static Image shadowTopRight = Properties.Resources.tshadowtopright;//new Bitmap(typeof(ShadowPanel),"Images.tshadowtopright.png");

        public MpShadowPanel() {

...
namespace MonkeyPaste {
    public class MpCopyItemTileTitlePanelController : MpController {
        ...
        //icon controller
        private MpCopyItemTileHeaderIconPanelController _copyItemTileTitleIconPanelController { get; set; }
        public MpCopyItemTileHeaderIconPanelController CopyItemTileTitleIconPanelController { get { return _copyItemTileTitleIconPanelController; } set { _copyItemTileTitleIconPanelController = value; } }

        //title menu controller 
        private MpCopyItemTileHeaderIconPanelController _copyItemTileTitleMenuPanelController { get; set; }
        public MpCopyItemTileHeaderIconPanelController CopyItemTileHeaderMenuPanelController { get { return _copyItemTileTitleMenuPanelController; } set { _copyItemTileTitleMenuPanelController = value; } }
        ...
        public MpCopyItemTileTitlePanelController(int tileSize,MpCopyItem ci,Color tileColor,MpController parentController) : base(parentController) {
            ...
            CopyItemTileTitleIconPanelController = new MpCopyItemTileHeaderIconPanelController(th,ci,this);
           
            CopyItemTileHeaderMenuPanelController = new MpCopyItemTileHeaderMenuPanelController(this);
            /*
       ...
       /* public void UpdateTileSize(int tileSize) {
        ...
        public override void UpdateBounds() {
            //tile size
            int ts = ((MpCopyItemTileController)ParentController).CopyItemTilePanel.Bounds.Height;
            //tiletitle height
            int tth = (int)((float)ts * (float)MpSingletonController.Instance.GetSetting("TileMenuHeightRatio"));
            //tile pad
            int tp = (int)((float)MpSingletonController.Instance.GetSetting("TilePadWidthRatio") * (float)ts);

            CopyItemTileTitlePanel.SetBounds(tp,tp,ts - tp,tth);          
        }
    }
}
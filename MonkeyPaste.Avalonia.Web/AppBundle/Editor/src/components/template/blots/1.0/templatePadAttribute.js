...
class TemplatePadBlot extends Parchment.Embed {
...
function registerTemplatePadAttribute() {
    ...
    let templatePadAttribute_pre = new Parchment.Attributor.Attribute('templatePad_pre', 'templatePad_pre', config);
    Parchment.register(templatePadAttribute_pre, suppressWarning);

    let templatePadAttribute_post = new Parchment.Attributor.Attribute('templatePad_post', 'templatePad_post', config);
    Parchment.register(templatePadAttribute_post, suppressWarning);

    let domNode_attr = new Parchment.Attributor.Attribute('domNode', 'domNode', config);
    Parchment.register(domNode_attr, suppressWarning);
